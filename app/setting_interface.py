...
from app.components.setting.search_integration import (
    get_search_integrator, SearchEnabledSettingsInterface
)
...
class Setting(ScrollArea, SearchEnabledSettingsInterface):
    ...
    def __initLayout(self):
        ...
        self.layout_manager.setup_interfaces(
            ...
            self.AppearanceInterface, self.BehaviorInterface,
            self.NetworkInterface, self.SystemInterface
        )
    ...
    def on_setting_found(self, setting_key: str, widget):
        ...
        try:
            ...
            for interface_name, interface in interfaces:
                if self._widget_in_interface(widget, interface):
                    ...
                    logger.info(f"Navigated to {interface_name} interface for setting: {setting_key}")
                    break
