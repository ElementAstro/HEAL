import os
import subprocess
from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QStackedWidget, QPushButton, QFileDialog, QPlainTextEdit
...
class Module(ScrollArea):
    ...
    def __init__(self, text: str, parent=None):
        ...
        # 添加文件扫描按钮
        #self.scanFolderButton = PushButton('扫描文件夹', self.scrollWidget)
        #self.vBoxLayout.addWidget(self.scanFolderButton)
        
        # 显示文件内容的文本框
        #self.fileContentTextEdit = TextEdit(self.scrollWidget)
        #self.vBoxLayout.addWidget(self.fileContentTextEdit)
        ...
        if folder_path:
            ...
            for file_name in file_list:
                ...
                with open(file_path, 'r', encoding='utf-8') as file:
                    ...
                    self.fileContentTextEdit.insertPlainText(f"文件：{file_name}\n{file_content}\n")
