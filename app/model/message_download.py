...
class HyperlinkCard(SettingCard):
    def __init__(self, urls: list[tuple[str, str]], icon: Union[str, QIcon, FluentIconBase], title: str, content: str = None, parent=None):
...
class MessageDialog(MessageBoxBase):
    def __init__(self, title: str, content: str, items: list[str], parent=None):
