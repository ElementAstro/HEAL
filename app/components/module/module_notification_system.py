...
from PySide6.QtCore import QObject, Signal, QTimer, QPropertyAnimation, QEasingCurve, QRect
from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QFrame
from PySide6.QtGui import QFont, QPixmap, QIcon
from PySide6.QtCore import Qt
from qfluentwidgets import FluentIcon, InfoBar, InfoBarPosition, InfoBarIcon
...
class ToastNotification(QFrame):
    ...
    def show_animated(self, target_rect: QRect):
        ...
        start_rect = QRect(target_rect.x() + 400, target_rect.y(), 
    ...
    def dismiss(self):
        ...
        end_rect = QRect(current_rect.x() + 400, current_rect.y(),
...
class ModuleNotificationSystem(QObject):
    ...
    def show_progress(self, title: str, message: str, progress: float = 0, **kwargs) -> str:
    ...
    def update_progress(self, notification_id: str, progress: float, message: Optional[str] = None):
    ...
    def execute_action(self, notification_id: str, action_id: str) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.logger.info(f"Executed action {action_id} for notification {notification_id}")
    ...
    def get_unread_notifications(self) -> List[Notification]:
        ...
        return [n for n in self.notifications.values() if not n.read and not n.dismissed]
    ...
    def _add_to_queue(self, notification_id: str):
    ...
    def _get_toast_position(self, index: int) -> QRect:
        ...
        if self.toast_position == "top_right":
            ...
            x = parent_rect.width() - toast_width - margin
            y = parent_rect.height() - toast_height - margin - (index * (toast_height + margin))
        else:  # bottom_left
            x = margin
            y = parent_rect.height() - toast_height - margin - (index * (toast_height + margin))
    ...
    def load_notifications(self):
        ...
        try:
            ...
            self.logger.info(f"Loaded {len(notifications_data)} notifications from disk")
