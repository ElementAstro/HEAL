...
from qfluentwidgets import (
    CardWidget, HyperlinkCard, PrimaryPushSettingCard,
    ToolButton, FluentIcon, BodyLabel, CaptionLabel,
...
class EnhancedHyperlinkCard(HyperlinkCard):
    ...
    def __init__(self, url: str, text: str, icon, title: str, content: str, parent=None):
        super().__init__(url, text, icon, title, content, parent)
        self.logger = get_logger('enhanced_hyperlink_card', module='EnhancedHyperlinkCard')
    ...
    def _toggle_favorite(self):
        ...
        self.logger.info(f"收藏状态变更: {self.titleLabel.text()} - {self.is_favorited}")
...
class EnhancedPrimaryPushSettingCard(PrimaryPushSettingCard):
    ...
    def __init__(self, text: str, icon, title: str, content: str = None, parent=None):
        super().__init__(text, icon, title, content, parent)
        self.logger = get_logger('enhanced_primary_push_card', module='EnhancedPrimaryPushSettingCard')
        self.is_favorited = False
        self._add_enhanced_features()
...
class DownloadCategoryCard(CardWidget):
    ...
    def __init__(self, category_name: str, item_count: int, icon=None, parent=None):
...
class FavoriteCard(CardWidget):
    ...
    def __init__(self, title: str, url: str, category: str, parent=None):
        super().__init__(parent)
        self.title = title
        self.url = url
    ...
    def init_ui(self):
        ...
        open_btn.clicked.connect(lambda: self.favorite_clicked.emit(self.title, self.url))
