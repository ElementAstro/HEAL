...
class EnvironmentNavigationManager(QObject):
    ...
    def __init__(self, parent_widget: QWidget):
        ...
        self.logger = get_logger('environment_navigation_manager', module='EnvironmentNavigationManager')
        
        # UI组件将由外部设置
        self.pivot: Optional[Pivot] = None
        self.stacked_widget: Optional[QStackedWidget] = None
    
    def set_navigation_components(self, pivot: Pivot, stacked_widget: QStackedWidget):
        """设置导航组件"""
        self.pivot = pivot
    ...
    def navigate_to_widget(self, widget: QWidget):
        """导航到指定组件"""
        if self.stacked_widget:
    ...
    def _update_navigation_state(self, widget: QWidget):
        """更新导航状态"""
    ...
    def setup_layout(self, vbox_layout: QVBoxLayout):
        """设置布局"""
        if self.pivot:
    ...
    def set_default_interface(self, widget: QWidget):
        """设置默认界面"""
