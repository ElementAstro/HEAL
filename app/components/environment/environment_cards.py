...
from qfluentwidgets import (
    FluentIcon, HyperlinkButton, PrimaryPushButton
)
...
class PrimaryPushSettingCardDownload(SettingCard):
    ...
    def __init__(
        ...
        self.logger = get_logger('environment_card', module='PrimaryPushSettingCardDownload')
        self.init_ui()
    ...
    def emit_download_signal(self, key: str):
        """发出下载信号"""
