"""
Proxy Navigation Manager
Handles navigation and interface management for proxy interface
"""
...
class ProxyNavigationManager(QObject):
    ...
    def __init__(self, parent_widget: Optional[QWidget] = None):
        ...
        self.logger = get_logger('proxy_navigation_manager', module='ProxyNavigationManager')
        
        # 界面组件
        self.pivot: Optional[Pivot] = None
        self.stacked_widget: Optional[QStackedWidget] = None
    
    def setup_navigation(self, pivot: Pivot, stacked_widget: QStackedWidget):
        """设置导航组件"""
        self.pivot = pivot
