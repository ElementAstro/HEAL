...
from app.model.config import Info, cfg, get_json
...
class FiddlerManager(QObject):
    ...
    def _show_file_not_found_error(self):
        """显示文件未找到错误"""
        file_error = InfoBar(
    ...
    def _navigate_to_download(self):
        """导航到下载页面"""
        # 这里可以发出信号通知主界面切换到下载页面
        self.logger.info("请求导航到下载页面。")
    
    def show_fiddler_tip(self, target_button):
        """显示Fiddler提示"""
    ...
    def backup_fiddler_script(self):
        """备份Fiddler脚本"""
