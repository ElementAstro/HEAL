...
class MainNavigationManager(QObject):
    ...
    def __init__(self, main_window):
        ...
        self.logger = get_logger('main_navigation_manager', module='MainNavigationManager')
    ...
    def init_navigation(self) -> None:
        ...
        # 界面配置
        interface_configs = [
            ('home', FluentIcon.HOME, self.main_window.tr('主页'), FluentIcon.HOME_FILL),
            ('launcher', FluentIcon.PLAY, self.main_window.tr('启动器'), FluentIcon.PLAY),
            ('download', FluentIcon.DOWNLOAD, self.main_window.tr('下载'), FluentIcon.DOWNLOAD),
            ('environment', FluentIcon.DICTIONARY, self.main_window.tr('环境'), FluentIcon.DICTIONARY),
    ...
    def get_interface(self, interface_key: str):
        """获取指定界面"""
