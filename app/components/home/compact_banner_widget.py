...
class CompactBannerWidget(QFrame):
    ...
    def _init_ui(self):
        ...
        self.app_subtitle = QLabel(f"Version {cfg.APP_VERSION} - Server Management Dashboard")
    ...
    def update_system_status(self, status: str, color: str = "#27AE60"):
    ...
    def add_custom_tip(self, tip: str):
    ...
    def remove_custom_tip(self, tip: str):
    ...
    def set_tips_list(self, tips: List[str]):
