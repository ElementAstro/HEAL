...
class LazyLoader:
    ...
    def __init__(self):
        ...
        self.executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="settings_loader")
...
class SettingsPerformanceManager(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.logger = get_logger('settings_performance', module='SettingsPerformanceManager')
    ...
    def get_setting(self, file_path: str, key: str, default_value: Any = None) -> Any:
    ...
    def set_setting(self, file_path: str, key: str, value: Any, immediate: bool = False) -> None:
    ...
    def _save_setting_immediate(self, file_path: str, key: str, value: Any) -> bool:
        ...
        try:
            # Load current data
            result = JsonUtils.load_json_file(file_path, create_if_missing=True, default_content={})
    ...
    def invalidate_cache(self, file_path: str, key: Optional[str] = None) -> None:
        ...
        if key:
            ...
            keys_to_remove = [k for k in self.cache.cache.keys() if k.startswith(f"{file_path}:")]
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if duration > 0.1:  # Log slow operations
                ...
                logger.warning(f"Slow setting operation {func.__name__}: {duration:.3f}s")
            return result
        except Exception as e:
            logger = get_logger('performance_decorator')
