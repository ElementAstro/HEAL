...
from app.components.setting.performance_manager import (
    get_performance_manager, performance_optimized, SettingsPerformanceManager
)
...
class EnhancedSettingsManager(QObject):
    ...
    def __init__(self, parent_widget: "Setting"):
        ...
        self.logger = get_logger('enhanced_settings_manager', module='EnhancedSettingsManager')
    ...
    def _register_lazy_settings(self):
        ...
        self.performance_manager.register_lazy_setting(
            'update_checker',
            lambda: self._initialize_update_checker()
        )
    ...
    def _handle_update_check(self):
        ...
        try:
            update_checker = self.performance_manager.load_lazy_setting('update_checker')
            if update_checker:
    ...
    def _handle_config_editor(self):
