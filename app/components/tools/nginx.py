...
from PySide6.QtWidgets import (
    ...
    QTableWidgetItem, QHeaderView, QGroupBox, QFormLayout, QFileDialog,
...
class NginxConfigurator(QFrame):
    ...
    def setup_log_monitor_tab(self):
        layout = QVBoxLayout()
    ...
    def delete_upstream(self, index: int):
...
"""
            for upstream in self.upstreams:
                config += f"        server {upstream.server} weight={upstream.weight};\n"
            config += "    }\n"
