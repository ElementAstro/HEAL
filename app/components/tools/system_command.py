...
from PySide6.QtWidgets import (
    ...
    QLabel, QListWidgetItem, QFormLayout, QGroupBox, QInputDialog,
    QSplitter, QFileDialog, QLineEdit, QPushButton, QTextEdit
)
from PySide6.QtCore import Qt, Signal, QThread
from PySide6.QtGui import QFont, QAction
from qfluentwidgets import (
    PushButton, LineEdit, TextEdit, ListWidget, Action, MessageBox,
    TitleLabel, SubtitleLabel, setTheme, Theme, isDarkTheme
)
...
class CommandExecutionThread(QThread):
    ...
    def __init__(self, command_name: str, *args: Any, user_permissions: List[str], **kwargs: Any):
        super().__init__()
...
class CommandCenter(QWidget):
    ...
    def load_command(self, item: QListWidgetItem):
    ...
    def show_command_description(self, item: QListWidgetItem):
        command_name = item.text().split(":")[0]
        command_info = command_dispatcher.get_command_info(command_name)
        if command_info:
