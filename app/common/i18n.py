...
class TranslationManager(QObject):
    ...
    def __init__(self):
        ...
        self.translation_dir = Path("src/data/translations")
    ...
    def _save_translation_file(self, language: Language, translations: Dict[str, str]):
        """保存翻译文件"""
        try:
    ...
    def add_translation(self, language: Language, key: str, value: str):
        """添加单个翻译"""
...
def setup_i18n(language: Union[Language, str] = Language.ENGLISH):
    """初始化国际化系统"""
...
def add_translation(language: Union[Language, str], key: str, value: str):
    """添加翻译"""
    if isinstance(language, str):
        try:
            language = Language(language)
