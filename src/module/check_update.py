...
def get_latest_version():
    if cfg.chinaStatus.value:
        url = 'https://raw.gitmirror.com/letheriver2007/Hello-ElementAstro-Launcher/main/config/version.json'
        proxy_support = urllib.request.ProxyHandler()
    elif cfg.proxyStatus.value:
        url = 'https://raw.githubusercontent.com/letheriver2007/Hello-ElementAstro-Launcher/main/config/version.json'
