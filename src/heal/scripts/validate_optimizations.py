...
def run_performance_benchmarks() -> Any:
    ...
    memory_benchmark = benchmark_function(
    ...
    json_benchmark = benchmark_function(
        "json_processing", json_processing_test, iterations=10)
    ...
    cache_benchmark = benchmark_function(
        "cache_performance", cache_performance_test, iterations=5)
    ...
    workflow_benchmark = benchmark_function(
        "workflow_performance", workflow_performance_test, iterations=10)
