...
class SingletonApplication(QApplication):
    ...
    def __init__(self, argv: List[str], key: str) -> None:
        super().__init__(argv)
        self.key = key
        self.timeout = 1000
...
def application_exception_hook(exception_type: Type[BaseException], value: BaseException, tb: TracebackType | None) -> None:
