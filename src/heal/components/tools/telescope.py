...
class AddEditTelescopeDialog(QDialog):
    def __init__(self, parent: QWidget | None = None, telescope: Telescope | None = None) -> None:
...
class TelescopeCatalog(QWidget):
    ...
    def populate_telescopes(self) -> None:
    ...
    def filter_telescopes(self) -> None:
    ...
    def edit_telescope(self, item: QListWidgetItem) -> None:
    ...
    def delete_selected_telescope(self) -> None:
        index = self.telescopes_list.currentRow()
        if index >= 0:
            telescope = self.filtered_telescopes[index]
    ...
    def copy_selected_telescope(self) -> None:
        index = self.telescopes_list.currentRow()
        if index >= 0:
            telescope = self.filtered_telescopes[index]
            details = (
