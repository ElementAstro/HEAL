...
class LogPanel(ScrollArea):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.log_viewer: Any = None
        self.log_filter: Any = None
    ...
    def _setup_ui(self) -> None:
        ...
        # Set proper scroll area properties
    ...
    def _create_header_section(self, parent_layout: QVBoxLayout) -> None:
        ...
        header_card.setContentsMargins(16, 16, 16, 16)

        # Add subtitle using a separate label with proper styling
    ...
    def _create_stats_section(self, parent_layout: QVBoxLayout) -> None:
        ...
        stats_layout.setSpacing(16)  # Add proper spacing between cards
    ...
    def _create_main_content(self, parent_layout: QVBoxLayout) -> None:
        ...
        # 设置分割器比例 (70% : 30%) and minimum sizes
        splitter.setSizes([700, 300])
        splitter.setStretchFactor(0, 7)  # Log viewer gets more stretch
        splitter.setStretchFactor(1, 3)  # Right panel gets less stretch
    ...
    def _create_control_section(self, parent_layout: QVBoxLayout) -> None:
        ...
        control_layout.setContentsMargins(0, 16, 0, 0)  # Add top margin
        control_layout.setSpacing(12)  # Consistent spacing between buttons

        # 刷新按钮
        self.refresh_btn = PrimaryPushButton(FIF.SYNC, "刷新日志")
        self.refresh_btn.setMinimumWidth(120)  # Consistent button width
        control_layout.addWidget(self.refresh_btn)

        # 清理按钮
        self.cleanup_btn = PushButton(FIF.DELETE, "清理旧日志")
        self.cleanup_btn.setMinimumWidth(120)
        control_layout.addWidget(self.cleanup_btn)

        # 归档按钮
        self.archive_btn = PushButton(FIF.FOLDER, "归档日志")
        self.archive_btn.setMinimumWidth(120)
