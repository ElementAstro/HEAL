...
class QuickActionBar(QFrame):
    ...
    def _init_ui(self) -> None:
        ...
        self.start_all_btn = PrimaryPushButton(
            FluentIcon.PLAY_SOLID, tr("home.start_all")
        )
    ...
    def update_server_counts(self, running_count: int, total_count: int) -> None:
    ...
    def _update_button_states(self) -> None:
        ...
        has_stopped_servers = (
            self.total_servers_count - self.running_servers_count
        ) > 0
    ...
    def highlight_action(self, action: str, duration: int = 2000) -> None:
