...
class DownloadNavigationManager(QObject):
    ...
    def __init__(self, parent_widget: QWidget) -> None:
        ...
        self.logger = get_logger(
            "download_navigation_manager", module="DownloadNavigationManager"
        )
    ...
    def navigate_to_widget(self, widget: QWidget, title: str) -> None:
        """导航到指定的组件"""
        if self.stacked_widget:
    ...
    def navigate_to_section_by_title(self, section_title: str) -> None:
        """根据标题导航到部分"""
    ...
    def navigate_to_section_by_id(self, section_id: str) -> None:
        """根据ID导航到指定部分"""
        for i, widget in enumerate(self.section_widgets):
