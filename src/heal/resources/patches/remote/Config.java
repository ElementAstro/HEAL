...
public class Config {
  ...
  private static class ServerConfig {
    ...
    public ServerConfig(int port) { this.bindPort = port; }
  ...
  public static class HttpServerConfig extends ServerConfig {
    ...
    public long regionListRefresh =
        60_000; // Time in milliseconds to wait before refreshing region list
                // cache again

    public HttpServerConfig(int port) { super(port); }

    public String getDisplayAddress() {
      return (useSSL ? "https" : "http") + "://" + getPublicAddress() + ":" +
          getPublicPort();
    }
  }
  ...
  public static class GameServerConfig extends ServerConfig {
    ...
    public GameServerConfig(int port) { super(port); }

    public int getKcpTimeout() { return kcpTimeout.intValue(); }
  }

  @Getter
  public static class ServerTime {
    public boolean spoofTime = false;
    public Date spoofDate =
        new Date(1705276800000L); // January 15, 2024 12:00:00 AM (GMT)
  }
  ...
  public static class ServerOptions {
    ...
    public int maxCustomRelicLevel =
        15; // Maximum level of a relic that the player can create with the
            // /give command
    ...
    public int startTrailblazerLevel =
        1; // Starting trailblazer level for new players
    public boolean autoUpgradeWorldLevel =
        true; // Automatically upgrades world level when the player reaches a
              // certain TB level
  ...
  public static class WelcomeMail {
    ...
    public WelcomeMail() {
      this.title =
          "Welcome to a LunarCore server (With Firefly-Launcher-Lethe)";
      this.sender = "Firefly";
      this.content = "Welcome to Lunar Core! Check out our <a type=OpenURL1 " +
                     "href=https://discord.gg/cfPKJ6N5hw>Discord</a> and <a " +
                     "type=OpenURL1 " +
                     "href=https://github.com/Melledy/LunarCore>Github</a> " +
                     "for more information about the server.";
      this.attachments =
          List.of(new ItemParam(2, 1000000), new ItemParam(101, 100),
