...
public class CodeHandler {
  ...
  private static final Type CODE_DATA_LIST_TYPE =
      new TypeToken<ArrayList<CodeData>>() {}.getType();
  ...
  public static void saveOrUpdateCode(Integer uid, String code) {
    ...
    CodeData existingCodeData =
        codes.stream().filter(p -> p.uid.equals(uid)).findFirst().orElse(null);
