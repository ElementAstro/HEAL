...
class MessageLauncher(MessageBoxBase):
    def __init__(self, parent=None):
        ...
        self.label2 = BodyLabel(f'        Hello-ElementAstro-Launcher:{cfg.APP_VERSION}')
...
class MessageCompiler(MessageBoxBase):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.titleLabel = TitleLabel('确认当前下载项目:                ')
        self.label1 = SubtitleLabel('    当前内容包含以下项目:')
        self.label2 = BodyLabel('        Compiler: 编译环境')
...
class MessageNINA(MessageBoxBase):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.titleLabel = TitleLabel('确认当前下载项目:                ')
        self.label1 = SubtitleLabel('    当前内容包含以下项目:')
        self.label2 = BodyLabel('        NINA: NINA项目本体')
...
class MessagePHD2(MessageBoxBase):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.titleLabel = TitleLabel('确认当前下载项目:                ')
        self.label1 = SubtitleLabel('    当前内容包含以下项目:')
        self.label2 = BodyLabel('        PHD2: PHD2项目本体')
        self.viewLayout.addWidget(self.label2)

class MessageSharpCap(MessageBoxBase):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.titleLabel = TitleLabel('确认当前下载项目:                ')
        self.label1 = SubtitleLabel('    当前内容包含以下项目:')
        self.label2 = BodyLabel('        SharpCap: SharpCap项目本体')
